...
MIGRATIONS_PATH="./payloadcms-cms-fe/src/migrations"
MEDIA_PATH="./payloadcms-cms-fe/public/media"
...
ssh $PROD_USER@$PROD_SERVER "cd /home/ghaCICDDevOpsUser/payloadcms-cms-fe__migrations && tar czf - ." | tar xzf - -C $MIGRATIONS_PATH
...
ssh $PROD_USER@$PROD_SERVER "cd /home/ghaCICDDevOpsUser/payloadcms-cms-fe__migrations && cat .last_migration_run 2>/dev/null || echo ''" > "$MIGRATIONS_PATH/.last_migration_run"
...
ssh $PROD_USER@$PROD_SERVER "cd /home/ghaCICDDevOpsUser/payloadcms-cms-fe__media && tar czf - ." | tar xzf - -C $MEDIA_PATH
